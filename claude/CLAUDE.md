...
- Never edit generated files. These files (might be in a gen folder, named accordingly or have a comment indiciating) should ALWAYS be generated by a tool that you run, or that you ask me to run if you cannot
